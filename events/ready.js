...
module.exports = async client => {
  ...
  client.logger.log("Bot status is now: " + `www.twitchchat.ml | ${client.getSettings("default").prefix} help`)
  client.user.setActivity(`www.twitchchat.ml | ${client.getSettings("default").prefix} help`);
